...
import NavbarAdminProf from "../layout/NavbarAdminProf"; // NOVO: Import do Navbar
...
export default function TelaAdmin() {
  ...
  return (
    <>
      {/* NOVO: Navbar colocada fora do dashboard e recebendo a prop "admin" */}
      ...
      <div className="admin-dashboard">
        <header className="admin-header">
          ...
          {/* O botão de logout antigo foi removido daqui pois agora está integrado à Navbar */}
        </header>
