...
export default function Privacidade() {
 ...
 <p>A sua privacidade é importante para nós. É política do InclusivaMente respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site InclusivaMente, e outros sites que possuímos e operamos.</p>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o InclusivaMente oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do InclusivaMente, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
